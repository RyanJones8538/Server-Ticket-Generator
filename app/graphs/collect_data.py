...
from app.nodes.collect_data.collect_ideal_state import build_retrieve_ideal_state
from app.nodes.collect_data.collect_server_states import build_collect_server_states
...
def build_collect_data() -> CompiledStateGraph:
    ...
    collect_graph.add_node("collect_ideal_state", build_retrieve_ideal_state)
    collect_graph.add_node("collect_server_states", build_collect_server_states)
